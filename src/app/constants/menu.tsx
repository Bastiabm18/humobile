...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { name: 'Explorar',                path: 'dashboard/busqueda',         descripcion:'Explora Artistas y eventos', icon: <TbWorldSearch  className='text-4xl text-orange-500/80' />,                        role: ['ADMIN','user'],  membresia:['GRATIS']           },
