...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  return (
    <div className="min-h-screen py-20 bg-neutral-900 p-4 md:p-8">
      {/* Modal de Contacto */}
      {isModalOpen && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-xl border border-neutral-600 bg-neutral-700 text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full px-4 py-3 rounded-xl border border-neutral-600 bg-neutral-700 text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all resize-none"
              ...
              <div className="flex gap-3 pt-4">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="flex-1 py-3 rounded-xl border border-neutral-600 text-neutral-300 hover:bg-neutral-700 transition-colors font-medium"
                >
                  Cancelar
                </button>
                <button
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mt-8 mb-4 ">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className=" md:hidden inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-neutral-700 text-neutral-300 hover:bg-neutral-600 transition-colors"
          >
        ...
        >
          <div className="inline-flex items-center gap-3 mb-4">
            <GiSparkPlug className="text-4xl text-neutral-300" />
            <h1 className="text-4xl md:text-5xl font-bold text-white">
              Contáctanos
            </h1>
            <TbMessages className="text-4xl text-neutral-300" />
          </div>
          ...
          <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {socialMedia.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex flex-col items-center justify-center p-4 rounded-xl bg-neutral-700/50 hover:bg-neutral-700 transition-all duration-300 border border-neutral-600"
                  >
                    <div className={`text-3xl mb-2 ${social.iconColor}`}>
                      {social.icon}
                    </div>
                    <span className="text-sm font-medium text-neutral-300">{social.label}</span>
                  </motion.a>
                ))}
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-3 rounded-xl bg-neutral-700/50 border border-neutral-600">
            ...
            <motion.div
              ...
              className="mt-8 p-6 rounded-2xl bg-neutral-800 border border-neutral-700"
            >
              <div className="flex items-center gap-3 mb-4">
                <GiSparkPlug className="text-2xl text-neutral-300" />
        ...
        <motion.div
          ...
          className="mt-12 pt-8 border-t border-neutral-700 text-center"
        >
