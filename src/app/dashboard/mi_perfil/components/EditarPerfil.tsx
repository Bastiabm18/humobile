  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        {uploadSuccess && (
          <div className="absolute top-4 left-4 px-4 py-2 bg-green-500/20 text-green-400 border border-green-500/30 rounded-full text-sm font-medium backdrop-blur-sm">
            ✓ Imagen actualizada
          </div>
        )}
      </div>
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-5">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 p-3 bg-neutral-800/50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-neutral-400 mb-2">Dirección</p>
                    <textarea
          ...
          <div className="space-y-6">
            ...
            {/* Datos JSON específicos según tipo */}
            <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-5">
              <h2 className="text-xl font-semibold text-white mb-5 flex items-center gap-3">
              ...
              <div className="bg-neutral-900/30 rounded-lg p-4">
                <textarea
                  ...
                  className="w-full h-48 px-3 py-2 bg-neutral-800 border border-neutral-700 rounded-lg text-white font-mono text-sm focus:outline-none focus:border-purple-500"
