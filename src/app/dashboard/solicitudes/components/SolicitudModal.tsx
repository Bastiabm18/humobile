...
import { Solicitud } from "@/types/profile";
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-red-600/30">
              ...
              <th className="text-left p-6 font-medium text-red-300">Fecha</th>
              <th className="text-left p-6 font-medium text-red-300">Duración</th>
              <th className="text-left p-6 font-medium text-red-300">Plazo</th>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="p-6">
                      ...
                      <p className="text-gray-400 text-sm">por {s.creador}</p>
                    </td>
                    <td className="p-6">
                      <p className="font-medium">{format(s.fechaInicio, "dd MMM yyyy", { locale: es })}</p>
                      <p className="text-gray-400">
                        {format(s.fechaInicio, "HH:mm")} → {format(s.fechaFin, "HH:mm")}
                      </p>
                    </td>
                    <td className="p-6 text-red-400 font-bold">{horas} h</td>
                    <td className="p-6">
                        ...
                        {s.estado === "pendiente" && (
                          <>
                            <button
                              ...
                              className="px-5 py-2.5 bg-red-600 hover:bg-red-700 rounded-lg font-medium transition transform hover:scale-105"
                            >
                              Rechazar
                            </button>
                            <button
                              onClick={() => onAceptar(s.id, s.creador,s.tipo)}
                              className="px-5 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 rounded-lg font-medium transition transform hover:scale-105 shadow-lg"
                            >
                              Aceptar
                            </button>
                          </>
