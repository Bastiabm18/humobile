...
import { enviarCorreoContacto } from '../contacto/actions/actions';

interface ContactoProps {
  
}

export default function Contacto({}: ContactoProps) {
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  return (
    <div className="min-h-screen py-20 p-4 md:p-8">
      {/* Modal de Contacto */}
      {isModalOpen && (
      ...
      <div className="max-w-[90vw] mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-3 mb-4">
            <GiSparkPlug className="text-4xl text-blue-700" />
            <h1 className="text-4xl md:text-5xl font-bold text-white">
              Contáctanos
            </h1>
            <TbMessages className="text-4xl text-blue-700" />
          </div>
